...
const UserPerfil = ({ isOpen, onClose }) => {
			...
			<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
				<div className="bg-white p-8 rounded-lg shadow-lg relative w-[90vw] max-w-md sm:w-auto sm:max-w-sm sm:absolute sm:left-4 sm:bottom-[calc(4rem+50px)]">
					...
					<div className="flex flex-col items-center">
						...
						<h2 className="text-xl font-semibold mb-2">Nombre de Usuario</h2>
						<p className="text-gray-600">usuario@example.com</p>
					</div>
				</div>
			</div>
			<UserSettings isOpen={isSettingsOpen} onClose={handleCloseSettings} />
		</>
	);
};
